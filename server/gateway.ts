...
export function buildRegistry(): SubAppInfo[] {
  return [
    ...
    },
    {
      ...
      label: "Nexus Graph",
      description:
        "Knowledge graph API — bounded focused entity graphs, progressive traversal, and Louvain community summaries.",
      ...
      endpoints: [
        ...
        { method: "GET",  path: "/info",                         description: "Service info + endpoint list",auth: false },
        { method: "GET",  path: "/openapi.json",                 description: "OpenAPI spec",               auth: false },
        { method: "GET",  path: "/v1/graph/nodes",               description: "Bounded entity search",      auth: false },
        { method: "GET",  path: "/v1/graph/nodes/:id",           description: "Single node detail + neighbors", auth: false },
        { method: "GET",  path: "/v1/graph/edges",               description: "Bounded edges between node IDs", auth: false },
        { method: "GET",  path: "/v1/graph/clusters",            description: "Bounded Louvain communities", auth: false },
        { method: "GET",  path: "/v1/graph/subgraph/:id",        description: "Focused graph with progressive depth", auth: false },
