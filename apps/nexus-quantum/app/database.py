...
Config injection: call configure_engine(settings) once during app startup so
all subsequent callers use the injected settings. Tests inject SQLite in-memory.
"""
...
async def create_tables() -> None:
    from app.models import JobModel, CircuitModel  # noqa: F401
    engine = get_engine()
